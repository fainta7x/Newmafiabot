...
- **Does the evening's organizer pay? (user-approved 2026-09-24)** On club (CASUAL) and novice evenings the organizer never pays. On rating evenings and tournaments an organizer who plays pays the entry fee like every other player, so the prize and fund shares stay whole.
