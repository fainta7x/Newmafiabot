...
- Zero-round split-vote practice: `src/components/public/SplitVoteTraining.tsx`, with generated questions and approved vote mapping in `src/lib/splitVoteTraining.ts`.
