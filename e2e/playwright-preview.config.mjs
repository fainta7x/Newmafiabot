...
export default defineConfig({
  testDir: './tests',
  testMatch: ['crm-evening-roster.spec.mjs', 'ui-preview.spec.mjs', 'mobile-usability.spec.mjs', 'crm-visual-audit.spec.mjs', 'player-cabinet-visual-audit.spec.mjs', 'telegram-webapp-viewport.spec.mjs'],
  timeout: 30_000,
