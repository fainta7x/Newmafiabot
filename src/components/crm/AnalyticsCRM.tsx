  ...
  return (
    <div className="mx-auto max-w-5xl space-y-5">
      ...
      <div className="grid gap-3 md:grid-cols-3">
        <div className={card}><div className="flex items-center justify-between"><span className="text-[11px] font-bold text-text-secondary">Новички, вернувшиеся за 30 дней</span><TrendingUp className="h-4 w-4 text-success" /></div><div className="mt-2 text-[28px] font-black text-success">{data.cohortRetention30dRate}%</div><p className="mt-1 text-[10px] text-text-muted">{data.cohortReturnedIn30Days} из {data.cohortFirstVisits} первых визитов вернулись за 30 дней</p></div>
