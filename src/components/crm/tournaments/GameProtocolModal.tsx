...
export const GameProtocolModal: React.FC<GameProtocolModalProps> = ({
  ...
  const renderRoundCard = (round: any, rIdx: number, isNested = false) => {
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          setProtocol((prev) => {
                            ...
                            const syncRes = syncAllEventsToResults(cleanVotes, prev.shots || [], prev.first_killed_participant_id, playerResultsRef.current, { ...prev, votes: cleanVotes });
                            setPlayerResults(syncRes.player_results);
                            playerResultsRef.current = syncRes.player_results;
                            return syncRes.protocol;
                          });
