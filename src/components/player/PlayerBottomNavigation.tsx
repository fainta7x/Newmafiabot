...
export default function PlayerBottomNavigation({
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-[var(--ds-layer-sticky)] border-t border-border bg-[var(--ds-surface)] px-1 pt-1.5 pb-[max(env(safe-area-inset-bottom),8px)] backdrop-blur-xl"
    >
