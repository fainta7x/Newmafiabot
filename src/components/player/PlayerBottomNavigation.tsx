...
export default function PlayerBottomNavigation({
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-[var(--ds-layer-sticky)] border-t border-border bg-card/95 px-1 pt-1.5 pb-[max(env(safe-area-inset-bottom),8px)] shadow-[0_-12px_32px_rgba(0,0,0,0.16)] backdrop-blur-xl"
    >
