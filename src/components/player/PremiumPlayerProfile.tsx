  ...
  return <main data-testid="premium-player-profile" className="min-h-full bg-[#090a0d] text-white">
    <div className="mx-auto w-full max-w-[520px] px-3 pb-28 pt-3">
      ...
      <header className="relative overflow-hidden rounded-[30px] border border-white/10 bg-gradient-to-br from-white/[0.11] via-white/[0.055] to-black/30 p-4 shadow-[0_24px_80px_rgba(0,0,0,.32)] motion-safe:animate-[fade-in_.22s_ease-out]">
        ...
        {summary.stats?.strongest_role ? <div className="relative mt-3 flex items-center justify-between gap-3 rounded-2xl bg-black/20 px-3 py-2.5 text-sm"><span className="text-white/45">Самая успешная роль</span><strong className="text-right">{summary.stats.strongest_role.label} · {summary.stats.strongest_role.win_rate}% <span className="font-normal text-white/35">({countGames(summary.stats.strongest_role.games)})</span></strong></div> : null}
      </header>
