...
export const tournamentGameProtocols = sqliteTable('tournament_game_protocols', {
  ...
  end_reason: text('end_reason').notNull().default('normal'),
  ppk_culprit_participant_id: text('ppk_culprit_participant_id'),
  created_at: text('created_at').notNull(),
  updated_at: text('updated_at').notNull(),
  completed_at: text('completed_at'),
});
...
export const tournamentGamePlayerResults = sqliteTable('tournament_game_player_results', {
  ...
  minor_technical_fouls: integer('minor_technical_fouls').notNull().default(0),
  major_technical_fouls: integer('major_technical_fouls').notNull().default(0),
  ...
  disciplinary_penalty_points: real('disciplinary_penalty_points').notNull().default(0),
