 ...
 * as «0» («в 2 проголосовали 3460»). The nominee list keeps commas (2, 1, 4, 10), and a single seat on
 * its own keeps «10».
 */
export const seatList = (seats: number[]) => seats.map((seat) => (seat === 10 ? '0' : String(seat))).join('');
